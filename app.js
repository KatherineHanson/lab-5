...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var newSum1 = sum(a,b)[0];
  var newSum2 = sum(newSum1,c)[0];
  var newProduct1 = multiply(a,b)[0];
  var newProduct2 = multiply(newProduct1,c)[0];
  var newSumString = a + ' and ' + b + ' and ' + c + ' sum to ' + newSum2 + '.';
  var newProductString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + newProduct2 + '.';
  return [newSum2,newProduct2,newSumString,newProductString];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var arraySumString = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + arraySum2 + ' is their sum.';
  return[arraySum2,arraySumString];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var arrayProductString = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + arrayProduct2 + '.';
  return [arrayProduct2,arrayProductString];
}
